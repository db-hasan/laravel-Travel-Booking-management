    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 pb-4 service-images">
                <img src="{{asset('frontend/images/travel.jpg') }}" class="card-img-top" alt="...">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 pb-4 service-images">
                <img src="{{asset('frontend/images/resort.jpg') }}" class="card-img-top" alt="...">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 pb-4 service-images">
                <img src="{{asset('frontend/images/health.avif') }}" class="card-img-top" alt="...">
            </div>
            <div class="col-md-6 pb-4 ">
