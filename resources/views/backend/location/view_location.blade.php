...
<div class="col p-4">
   @include('backend/location/add_location')
                        <hr>
                        <div class='row'>
                            <div class='col'>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><a href=""><i class="fa-solid fa-right-left fa-rotate-90 fa-sm"></i></a> Location Name
                                    </th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Active</td>
                                    <td class="icons">
                                        @include('backend/location/edit_location')
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Delete Location
                                                        </h1>
